...
namespace ZeroFrame.Application.DTOS.Usuario
{
    ...
    public class UsuarioMeusDadosPutDto
    {
        ...
        [EmailAddress(ErrorMessage = "O campo Email deve ser um endereco de email valido.")]
        [MaxLength(100, ErrorMessage = "O campo Email deve conter no maximo 100 caracteres.")]
        public string Email { get; set; } = string.Empty;
        ...
        [MinLength(6, ErrorMessage = "A nova senha deve conter no minimo 6 caracteres.")]
        [MaxLength(50, ErrorMessage = "A nova senha deve conter no maximo 50 caracteres.")]
