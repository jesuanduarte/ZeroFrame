...
namespace ZeroFrame.Application.DTOS.Produto
{
    ...
    public class ProdutoPostDto
    {
        ...
        [MaxLength(1000, ErrorMessage = "O campo ImagemUrl deve conter no maximo 1000 caracteres.")]
        public string? ImagemUrl { get; set; }

        // Arquivo recebido via multipart/form-data. O banco salva apenas o caminho publico em ImagemUrl.
        public IFormFile? ImagemArquivo { get; set; }

        // Lista de imagens reais do produto; a primeira URL salva continua sendo a imagem principal.
        public List<IFormFile> ImagemArquivos { get; set; } = new();
